...
public class E1_ChaseState : ChasePlayerState
{
    private Enemy1 enemy;
    public E1_ChaseState(Entity entity, FiniteStateMachine stateMachine, string animBoolName, D_Chase stateData, Enemy1 enemy) : base(entity, stateMachine, animBoolName, stateData)
    {
        this.enemy = enemy;
    }
