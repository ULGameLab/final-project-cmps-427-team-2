namespace GameCreator.Shooter
{
    ...
    public abstract class IShooterEditor : Editor
	{
        private const float ANIM_BOOL_SPEED = 3f;
        private const string TEXTURE = "Assets/Plugins/GameCreator/Shooter/Extra/Toolbar/{0}.png";

        protected class Section
        {
            private const string KEY_STATE = "shooter-section-{0}";
