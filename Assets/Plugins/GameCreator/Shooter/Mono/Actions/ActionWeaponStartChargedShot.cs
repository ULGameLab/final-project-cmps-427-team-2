namespace GameCreator.Shooter
{
	...
	[AddComponentMenu("")]
	public class ActionWeaponStartChargedShot : IAction
	{
        ...
        public override bool InstantExecute(GameObject target, IAction[] actions, int index)
        {
            ...
            charShooter.StartChargedShot();
            return true;
        }

		#if UNITY_EDITOR

        public static new string NAME = "Shooter/Weapon Start Charged Shot";
        private const string NODE_TITLE = "{0} start Charging Shot";
